...
Renderer::Renderer(HINSTANCE hInstance, LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam), int nCmdShow)
{
	...
	//Loading textures
	{
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeHeadUp.png", &bitmaps[0])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeHeadDown.png", &bitmaps[1])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeHeadLeft.png", &bitmaps[2])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeHeadRight.png", &bitmaps[3])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeBody.png", &bitmaps[4])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeTailUp.png", &bitmaps[5])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeTailDown.png", &bitmaps[6])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeTailLeft.png", &bitmaps[7])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\BlueSnakeTailRight.png", &bitmaps[8])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeHeadUp.png", &bitmaps[9])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeHeadDown.png", &bitmaps[10])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeHeadLeft.png", &bitmaps[11])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeHeadRight.png", &bitmaps[12])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeBody.png", &bitmaps[13])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeTailUp.png", &bitmaps[14])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeTailDown.png", &bitmaps[15])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeTailLeft.png", &bitmaps[16])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\GreenSnakeTailRight.png", &bitmaps[17])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeHeadUp.png", &bitmaps[18])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeHeadDown.png", &bitmaps[19])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeHeadLeft.png", &bitmaps[20])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeHeadRight.png", &bitmaps[21])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeBody.png", &bitmaps[22])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeTailUp.png", &bitmaps[23])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeTailDown.png", &bitmaps[24])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeTailLeft.png", &bitmaps[25])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\YellowSnakeTailRight.png", &bitmaps[26])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeHeadUp.png", &bitmaps[27])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeHeadDown.png", &bitmaps[28])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeHeadLeft.png", &bitmaps[29])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeHeadRight.png", &bitmaps[30])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeBody.png", &bitmaps[31])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeTailUp.png", &bitmaps[32])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeTailDown.png", &bitmaps[33])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeTailLeft.png", &bitmaps[34])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\VioletSnakeTailRight.png", &bitmaps[35])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\Red.png", &bitmaps[36])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\Apple.png", &bitmaps[37])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\Border.png", &bitmaps[38])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\A.png", &bitmaps[39])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\B.png", &bitmaps[40])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\C.png", &bitmaps[41])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\D.png", &bitmaps[42])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\E.png", &bitmaps[43])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\F.png", &bitmaps[44])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\G.png", &bitmaps[45])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\H.png", &bitmaps[46])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\I.png", &bitmaps[47])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\J.png", &bitmaps[48])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\K.png", &bitmaps[49])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\L.png", &bitmaps[50])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\M.png", &bitmaps[51])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\N.png", &bitmaps[52])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\O.png", &bitmaps[53])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\P.png", &bitmaps[54])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\Q.png", &bitmaps[55])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\R.png", &bitmaps[56])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\S.png", &bitmaps[57])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\T.png", &bitmaps[58])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\U.png", &bitmaps[59])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\V.png", &bitmaps[60])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\W.png", &bitmaps[61])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\X.png", &bitmaps[62])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\Y.png", &bitmaps[63])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\Z.png", &bitmaps[64])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\+.png", &bitmaps[65])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\-.png", &bitmaps[66])) rendererErrors.push_back(LoadingBitmapError);

		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\0.png", &bitmaps[67])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\1.png", &bitmaps[68])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\2.png", &bitmaps[69])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\3.png", &bitmaps[70])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\4.png", &bitmaps[71])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\5.png", &bitmaps[72])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\6.png", &bitmaps[73])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\7.png", &bitmaps[74])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\8.png", &bitmaps[75])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\9.png", &bitmaps[76])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\SPACE.png", &bitmaps[77])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\DOT.png", &bitmaps[78])) rendererErrors.push_back(LoadingBitmapError);
		if (!LoadID2D1Bitmap(L"textures\\NewTextures\\ASCII\\EXCLAMATION POINT.png", &bitmaps[79])) rendererErrors.push_back(LoadingBitmapError);
	}
}
